...
\begin{frame}[fragile]
\frametitle{\bf Example: Abstract Syntax Tree}
\lstinputlisting[language=,keepspaces=true,basicstyle=\bfseries\tiny\ttfamily]{images/ex_ast.txt}
\end{frame}

\begin{frame}
\frametitle{\bf Example: High-level IR}
\lstinputlisting[language=,keepspaces=true,basicstyle=\bfseries\footnotesize\ttfamily]{images/ex_hir.txt}
\end{frame}

\begin{frame}
\frametitle{\bf Example: Low-level IR}
\lstinputlisting[language=,keepspaces=true,basicstyle=\bfseries\footnotesize\ttfamily]{images/ex_lir.txt}
\end{frame}
...
\lstinputlisting[language=,keepspaces=true,basicstyle=\bfseries\footnotesize\ttfamily]{images/ex_asm1.txt}
\end{column}

\begin{column}{0.33\textwidth}
\lstinputlisting[language=,keepspaces=true,basicstyle=\bfseries\footnotesize\ttfamily]{images/ex_asm2.txt}
\end{column}

\begin{column}{0.33\textwidth}
\lstinputlisting[language=,keepspaces=true,basicstyle=\bfseries\footnotesize\ttfamily]{images/ex_asm3.txt}
\end{column}
...
% -- Slide ---------------------------------------------------------------------
\begin{frame}
\frametitle{\bf JavaScript Extensions}
    \begin{itemize}
...
% -- Slide ---------------------------------------------------------------------
\begin{frame}
\lstinputlisting[language=JavaScript]{images/boxIsInt.js}
\end{frame}
% ------------------------------------------------------------------------------
...
\frametitle{\bf Example: Optimization Issues}
    \lstinputlisting[language=JavaScript]{images/sum.js}
    \begin{itemize}
...
% -- Slide ---------------------------------------------------------------------
\begin{frame}
\frametitle{\bf Type Propagation}
    \begin{itemize}
...
% -- Slide ---------------------------------------------------------------------
\begin{frame}
\frametitle{\bf Related Work: Type Analysis}
    \begin{itemize}
...
% -- Slide ---------------------------------------------------------------------
\begin{frame}
\frametitle{\bf Related work: Deoptimization}
    \begin{itemize}
...
% -- Slide ---------------------------------------------------------------------
\begin{frame}
\frametitle{\bf Related Work: Tracing JITs}
    \begin{itemize}
