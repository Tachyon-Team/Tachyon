...
% TODO list:
% - [ ] Wrap some lines, change undefined to undef, scale up listing text
% - [ ] Cut type profiling slides
% - [ ] Cut related work slides
% - [ ] Add slide for C sum code. Question, in bold: Could we eliminate all conditional
...
\scalebox{0.7}{\lstinputlisting[language=,keepspaces=true,basicstyle=\bfseries\footnotesize\ttfamily]{images/ex_hir.txt}}
\end{frame}

\begin{frame}
\frametitle{\bf Example: Low-level IR}
\scalebox{0.65}{\lstinputlisting[language=,keepspaces=true,basicstyle=\bfseries\footnotesize\ttfamily]{images/ex_lir.txt}}
\end{frame}
...
\frametitle{\bf Type Profiling}
    \begin{itemize}
        ...
        \item Goal: build accurate profile of program behavior w.r.t. types
    \end{itemize}
\end{frame}
% ------------------------------------------------------------------------------
