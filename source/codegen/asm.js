...
// File: "asm.js", Time-stamp: <2010-06-18 13:00:22 feeley>
...
asm_CodeBlock.prototype.extend = function (x)
{
    this.code.push(x);
};


asm_CodeBlock.prototype.gen8 = function (n)
{
    this.extend(n & 0xff);
};


asm_CodeBlock.prototype.gen16 = function (n)
{
    if (this.bigEndian)
        this.gen16BE(n);
    else
...
asm_CodeBlock.prototype.gen16BE = function (n)
{
    this.gen8(n >> 8);
    this.gen8(n);
};
...
asm_CodeBlock.prototype.gen16LE = function (n)
{
    this.gen8(n);
    this.gen8(n >> 8);
};
...
asm_CodeBlock.prototype.gen32 = function (n)
{
    if (this.bigEndian)
        this.gen32BE(n);
    else
...
asm_CodeBlock.prototype.gen32BE = function (n)
{
    this.gen16(n >> 16);
    this.gen16(n);
};
...
asm_CodeBlock.prototype.gen32LE = function (n)
{
    this.gen16(n);
    this.gen16(n >> 16);
};

asm_CodeBlock.prototype.gen64 = function (n)
{
...
asm_CodeBlock.prototype.gen64BE = function (n)
{
    // TODO: in JS n is a double, so only 52 bits are significant.
    this.gen32(n >> 32);
    this.gen32(n);
...
asm_CodeBlock.prototype.gen64LE = function (n)
{
    // TODO: in JS n is a double, so only 52 bits are significant.
    this.gen32(n);
    this.gen32(n >> 32);
...
asm_CodeBlock.prototype.genListing = function(text)
{
    this.extend(text);
};


asm_CodeBlock.prototype.assemble = function ()
{
    var c = this.code;
    this.pos = 0;
    this.code = [];
...
asm_CodeBlock.prototype.flatten = function (x)
{
...
asm_CodeBlock.prototype.assembleToMachineCodeBlock = function ()
{
