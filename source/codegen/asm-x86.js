...
// File: "asm-x86.js", Time-stamp: <2010-06-18 13:46:58 feeley>

// Copyright (c) 2010 by Marc Feeley, All Rights Reserved.

//=============================================================================

// This module implements the x86 assembler.

//-----------------------------------------------------------------------------

// This is a translation of code originally written in Scheme in
// the context of the Gambit Scheme compiler.

// The translation is not yet complete.  The Scheme code can be found
...
x86_Assembler.prototype.gen8 = function (n)
{
    this.codeBlock.gen8(n);
};


x86_Assembler.prototype.gen16 = function (n)
{
    this.codeBlock.gen16(n);
};


x86_Assembler.prototype.gen32 = function (n)
{
    this.codeBlock.gen32(n);
};


x86_Assembler.prototype.gen64 = function (n)
{
    this.codeBlock.gen64(n);
};
...
x86_Assembler.prototype.ret = function () { this.noOpndInstr(0xc3, "ret"); };
x86_Assembler.prototype.cmc = function () { this.noOpndInstr(0xf5, "cmc"); };
x86_Assembler.prototype.clc = function () { this.noOpndInstr(0xf8, "clc"); };
x86_Assembler.prototype.stc = function () { this.noOpndInstr(0xf9, "stc"); };
x86_Assembler.prototype.cli = function () { this.noOpndInstr(0xfa, "cli"); };
x86_Assembler.prototype.sti = function () { this.noOpndInstr(0xfb, "sti"); };
x86_Assembler.prototype.cld = function () { this.noOpndInstr(0xfc, "cld"); };
x86_Assembler.prototype.std = function () { this.noOpndInstr(0xfd, "std"); };


x86_Assembler.prototype.noOpndInstr = function (opcode, mnemonic)
{
    this.gen8(opcode);
    if (this.listing)
...
x86_Assembler.prototype.genListing = function(text)
{
    this.codeBlock.genListing(text);
};


x86_Assembler.prototype.instrFormat = function(mnemonic, suffix)
{
...
// the following is just for the test


x86_Assembler.prototype.addImm8ESP = function (n)
{
    this.gen8(0x83);  this.gen8(0xc4);  this.gen8(n);
};


x86_Assembler.prototype.instr1 = function ()
{
    this.gen8(0x8b);  this.gen8(0x44);  this.gen8(0x24);  this.gen8(0x10);
};


x86_Assembler.prototype.instr2 = function ()
{
    this.gen8(0xff);  this.gen8(0x50);  this.gen8(0x0c);
};


x86_Assembler.prototype.instr3 = function ()
{
    this.gen8(0xff);  this.gen8(0x50);  this.gen8(0x10);
};


x86_Assembler.prototype.pushImm8 = function (k)
{
    this.gen8(0x6a);
    this.gen8(k);
};
