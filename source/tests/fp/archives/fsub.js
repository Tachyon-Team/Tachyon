...
a.
push($(0)).                                // Reserve a space on stack
gen8(0xD9).gen8(0xE8).                     genListing("fld1: push(ST, 1)").
gen8(0xD9).gen8(0xE8).                     genListing("fld1: push(ST, 1)").
gen8(0xD8).gen8(0xE1).                     genListing("fsub: ST(0) <- [ST(0)] - [ST(1)]").
gen8(0xDB).opndModRMSIB(3, mem(0,ESP)).    genListing("fistp(0)").
pop(EAX).                                  // Move the value on top of stack
                                           // in EAX and restore stack
