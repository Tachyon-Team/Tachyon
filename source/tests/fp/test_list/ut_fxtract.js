...
print('0x' + float2hex(b, 0, 64) +  ' expected: 0x400921fb54442d18');
print('0x' + float2hex(b, 1, 64) +  ' expected: 0x3ff921fb54442d18');
print('0x' + float2hex(b, 2, 64) +  ' expected: 0x3ff0000000000000');
